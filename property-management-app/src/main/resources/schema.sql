...
drop table if exists meeting_tracker cascade
create table association_meeting (meeting_id bigint generated by default as identity, approval_date_time varchar(255), approver_id bigint, scheduled_date varchar(255), scheduled_time varchar(255), tracker_id varchar(255), community_id bigint not null, correlation_id varchar(255), primary key (meeting_id))
